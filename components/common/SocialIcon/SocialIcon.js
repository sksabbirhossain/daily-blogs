  ...
  return (
    <div className="flex flex-wrap gap-3">
      <div className=" h-[35px] w-[35px]">
        <Link href="/">
          <span className="flex h-full w-full items-center justify-center rounded-md border border-[#00AAA1] hover:bg-[#00AAA1] hover:text-[#fff] dark:text-gray-100 dark:bg-slate-800 dark:border-gray-700">
