    ...
    <div className="flex flex-wrap gap-3">
      <div className=" h-[35px] w-[35px]">
        <Link
          ...
          target="_blank"
        >
          <span className="flex h-full w-full items-center justify-center rounded-md border border-[#00AAA1] hover:bg-[#00AAA1] hover:text-[#fff] dark:border-gray-700 dark:bg-slate-800 dark:text-gray-100">
      ...
      <div className=" h-[35px] w-[35px]">
        <Link href="https://www.x.com" aria-label="Twitter" target="_blank">
          <span className="flex h-full w-full items-center justify-center rounded-md border border-[#00AAA1] hover:bg-[#00AAA1] hover:text-[#fff] dark:border-gray-700 dark:bg-slate-800 dark:text-gray-100">
