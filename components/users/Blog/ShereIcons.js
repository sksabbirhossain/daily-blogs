  ...
  return (
    <div className="flex flex-wrap gap-3">
      <div className=" h-[25px] w-[25px]">
        <Link href="/">
          <span className="flex h-full w-full items-center justify-center rounded-md border border-[#00AAA1] hover:bg-[#00AAA1] hover:text-[#fff] dark:bg-slate-800 dark:text-gray-200 dark:border-gray-700">
            <svg
      ...
      <div className=" h-[25px] w-[25px]">
        <Link href="/">
          <span className="flex h-full w-full items-center justify-center rounded-md border border-[#00AAA1] hover:bg-[#00AAA1] hover:text-[#fff] dark:bg-slate-800 dark:text-gray-200 dark:border-gray-700">
            <svg viewBox="0 0 500 1000" fill="currentColor" className="h-4 w-4">
