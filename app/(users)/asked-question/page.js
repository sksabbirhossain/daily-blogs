      ...
      <div className="flex w-full justify-center">
        <div className="w-full max-w-[700px] space-y-5 sm:space-y-10">
          ...
          <div className="space-y-3 px-2 sm:px-0">
            {/* 1 */}
            <div className="rounded-md bg-[#F2F8F7]">
              <div className="flex items-center justify-between rounded-ss-md rounded-tr-md bg-[#DFF1F0] px-2 py-2">
                <h2 className="text-sm font-bold capitalize text-[#222] sm:text-lg sm:font-medium">
              ...
              <p className=" sm:tex-xs px-2 py-2 text-[12px] font-normal text-[#666]">
         ...
         */}
          ...
          <div className="space-y-3 text-center">
            <h2 className="text-lg font-medium text-[#222] sm:text-xl">
              Cant find an answer to your question?
            </h2>
            <button className="rounded-md  border border-[#00AAA1] px-3 py-1 text-sm text-[#222] duration-150 ease-linear hover:bg-[#00AAA1] hover:text-white sm:px-4 sm:py-2">
              <Link
                href={"/contact-us"}
