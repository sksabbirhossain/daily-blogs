    ...
    <div className="my-5 px-2 sm:my-10 sm:px-0">
      <div className="container mx-auto">
        <div className="space-y-10">
          ...
          <div className="space-y-5">
            <h2 className="text-xl font-bold text-[#00AAA1]">
          ...
          <div className="space-y-5">
            <h2 className="text-xl font-bold text-[#00AAA1]">Google Ads</h2>
            <p className="dark:text-gray-300">
          ...
          <div className="space-y-5">
            ...
            <p className="dark:text-gray-300">
              ...
              to support the content creation efforts on our website.
            </p>
            <div className="space-y-2">
              <h3 className="text-base font-medium">
              ...
              <p className="dark:text-gray-300">
                ...
                helps us maintain and improve our website, ensuring that we can
                continue to provide valuable content to our users.
              </p>
            </div>
            <div className="space-y-2">
              <h3 className="text-base font-medium">
              ...
              <p className="dark:text-gray-300">
                We value transparency and want to assure our users that the
                inclusion of affiliate links in our content does not compromise
                the integrity of our reviews or recommendations. Our commitment
                is to deliver honest and unbiased information, and we only
                promote products or services that we genuinely believe can
                provide value to our audience.
              </p>
            </div>
            <div className="space-y-2">
              <h3 className="text-base font-medium">Third-Party Websites</h3>
              <p className="dark:text-gray-300">
                Please note that when you click on an affiliate link and make a
            ...
            <div className="space-y-2">
              ...
              <p className="dark:text-gray-300">
                ...
                outlined in the Affiliate Marketing section of our Privacy
                Policy.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            <h2 className="text-xl font-bold text-[#00AAA1]">Security</h2>
            <p className="dark:text-gray-300">
          ...
          <div className="space-y-5">
            <h2 className="text-xl font-bold text-[#00AAA1]">Contact Us</h2>
            <p className="dark:text-gray-300">
